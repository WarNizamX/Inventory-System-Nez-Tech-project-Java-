...
<html>
    ...
    <body style="background-color:powderblue;">
        ...
        <div class="navbar-brand text-uppercase">
            <a href="" title="Category">
                <img src="../img/up.png" class="img-responsive" style="margin-top:0px; margin-left:20px; width:50px; height:50px "></a></div>
        <div class="navbar-brand text-uppercase">
            <a href="" style="text-decoration:none; margin-left:0px;"><font face="Lucida Calligraphy" size="5" color="#000000"><b>Current Stock</b></font></a>
        </div>
    ...
    <div  class="container-fluid">
        <nav class="navbar navbar-light">
            <a class="navbar-brand"><h2 style="color:darkcyan">Stock</h2></a>
    ...
    <div class="container">
        <div class="inner">
            <div class="row">
                ...
                <div class="col-md-11">
                    <h3 style="color:darkseagreen">Available Stock</h3>
                        ...
                        <tbody>
                            <c:forEach var="tempProd" items="${PROD_LIST}">
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" class="button"><a href="updateOrder.jsp?prod_id=${tempProd.prod_id }">+</a></button>
                                        <button type="submit" class="button"><a href="deleteOrder.jsp?prod_id=${tempProd.prod_id }">-</a></button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
