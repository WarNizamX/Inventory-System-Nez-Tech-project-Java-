...
<%
    ...
    BooksDao bkd = new BooksDao(ConnectionPro.getConnection());
                    ...
                    <div class="col-12">
                        ...
                        <form action="EditBookServlet" method="post">
                            <div class="form-group">
                                <label>Book ID</label>
                                <input class="form-control" name="id" value="${edit_books.id }" required>
                            </div>
                            <div class="form-group">
                                <label>Book Name</label>
                                <input class="form-control" name="bookName" value="${edit_books.bookName }" required>
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <input class="form-control" name="bookDesc" value="${edit_books.bookDesc}" required>
                            </div>
                            <div class="form-group">
