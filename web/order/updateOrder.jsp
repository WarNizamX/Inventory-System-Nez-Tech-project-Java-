    ...
    <body>
        <div  class="container-fluid">
            <nav class="navbar navbar-light">
                 <a href="../order/index.jsp"><img src="../img/b.png" class="img-responsive" style="margin-top:20px; margin-left:20px; width:70px; height:70px "></a>
        ...
        <div class="inner">
            <div class=" container">
                <div class="row">
                    <div class="col-12">
                        <h3>Update Stock</h3>
                        <form action="../UpdateProdsServlet" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="prod_quantity" value="" required>
                            </div>
                            
                            
                            <button type="submit" class="button">Submit</button>
                            <button  class="button"><a href="../order/index.jsp">Cancel</a></button>
                        </form>
                    </div>
                </div>
            </div>
