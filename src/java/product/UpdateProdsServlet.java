...
public class UpdateProdsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateProdsServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            boolean success = bkdao.updateProductInfo(prod);
            ...
            if (success){
                ...
                out.println("<img src=\"img/eror.gif\"></img>");
                 out.println("<FONT FACE=\"Comic Sans Ms, Times, Arial\" COLOR=\"#000000\" SIZE=\"big\">");
                 out.println("<body bgcolor='#E6E6FA' text='green' <h1>Error !!</h1>");
            }
